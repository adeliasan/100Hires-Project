...
Tools installed / Platforms used:
- Cursor IDE
...
5. Installed Git Bash to simplify CLI setup and terminal usage.
6. Accessed the Claude Code login page successfully after completing the CLI setup.
7. Discovered that Claude Code requires a paid subscription to use its Pro models.
8. Researched alternatives and identified that Cursor already provides built-in Claude models, including Claude Sonnet, which can be used as an alternative.
9. Installed the Codex extension in Cursor.
10. Logged into Codex successfully using my OpenAI account.
11. Created a GitHub account and a public repository for this project.
12. Cloned the repository to my local machine using Git Bash.
13. Opened the repository in Cursor.
